    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Manage gym members, routines and progress</p>
        </div>
        <Link
          href="/athletes/new"
      ...
      <div className="relative group">
        ...
        <input
          type="text"
          placeholder="Search athletes by name, email..."
          value={search}
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-3xl overflow-hidden backdrop-blur-md">
        {loading ? (
          <div className="p-20 text-center">
            ...
            <p className="text-slate-400 font-medium">Retrieving gym records...</p>
          </div>
        ) : error ? (
          <div className="p-20 text-center">
          ...
          <div className="p-20 text-center">
            ...
            <p className="text-slate-400 font-medium text-lg">No athletes found</p>
            <p className="text-slate-500 text-sm mt-1">Try a different search or add a new athlete</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-800/30 border-b border-slate-700/50">
                  <th className="px-8 py-5 text-xs font-bold text-slate-500 uppercase tracking-widest">Athlete</th>
                  <th className="px-8 py-5 text-xs font-bold text-slate-500 uppercase tracking-widest">Plan Status</th>
                  <th className="px-8 py-5 text-xs font-bold text-slate-500 uppercase tracking-widest">Current Body</th>
                  <th className="px-8 py-5 text-xs font-bold text-slate-500 uppercase tracking-widest">Membership</th>
                  <th className="px-8 py-5 text-right text-xs font-bold text-slate-500 uppercase tracking-widest">Details</th>
                </tr>
              </thead>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="text-xs text-slate-500 pl-5">
                          {athlete.body_fat_pct ? `${athlete.body_fat_pct}% BF` : "No BF data"}
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-2 text-sm text-slate-300">
                        ...
                        {athlete.plan_expiry ? new Date(athlete.plan_expiry).toLocaleDateString() : "No expiry"}
                      </div>
                    </td>
